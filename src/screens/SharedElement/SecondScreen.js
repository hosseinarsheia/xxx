...
import { View, Text, Alert, TouchableOpacity, Image, FlatList, Dimensions, Animated } from 'react-native'
...
const SecondScreen = ({ navigation, route }) => {
  ...
  const translateX = activeIndexAnimation.interpolate({ inputRange: [-1, 0, 1], outputRange: [SIZE, 0, -SIZE] })
    ...
    <View style={{ flex: 1 }}>
      <Animated.View
        ...
        {ICON_LIST.map((item, index) => {
          return (
            <View style={{ width: ICON_SIZE, margin: SPACING, alignItems: 'center', justifyContent: 'center' }}>
