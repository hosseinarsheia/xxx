  ...
  return (
    <View style={styles.itemContainer}>
      <View style={[StyleSheet.absoluteFill, { overflow: 'hidden', borderRadius: 10 }]}>
        <Animated.Image source={item.url} style={[StyleSheet.absoluteFill, { resizeMode: 'contain', transform: [{ scale }] }]} />
      </View>

      <Animated.Text style={[R.styles.normalFont, { position: 'absolute', transform: [{ translateX }], opacity }]}>
        {item.title}
      </Animated.Text>
